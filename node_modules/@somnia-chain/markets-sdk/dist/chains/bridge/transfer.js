...
import { encodeFunctionData, isAddress, numberToHex, pad } from "viem";
 ...
 *   what IS supported.
 */
export function createBridgeTransfer(params) {
 ...
 */
export function toEip1193Transaction(step, options = {}) {
    return {
...
function buildApproval(origin, amount, token) {
    ...
    if (origin.model !== "collateral" || amount === 0n)
        return undefined;
    if (!origin.address)
        return undefined; // unreachable for collateral; keeps the type honest
    return {
