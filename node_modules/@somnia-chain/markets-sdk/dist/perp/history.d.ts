 ...
 *  one pool, paginated.
 */
export declare function getFundingPayments(account: string, opts: {
    pool?: string;
    limit?: number;
    offset?: number;
} | undefined, indexerUrl: string): Promise<FundingPayment[]>;
/**
 *  An account's margin-account movement history (deposits/withdraws/locks),
 *  newest first — paginated.
 */
export declare function getMarginEvents(account: string, opts: {
    limit?: number;
    offset?: number;
} | undefined, indexerUrl: string): Promise<MarginEvent[]>;
/**
 *  Liquidation events, newest first — filter by `account` and/or `pool`,
 *  paginate.
 */
export declare function getLiquidations(opts: {
    account?: string;
    pool?: string;
    limit?: number;
    offset?: number;
} | undefined, indexerUrl: string): Promise<LiquidationEvent[]>;
/**
 ...
 */
export declare function listFundingRateHistory(pool: string, opts: {
    limit?: number;
    offset?: number;
    from?: number | bigint;
    to?: number | bigint;
    order?: "asc" | "desc";
} | undefined, indexerUrl: string): Promise<FundingRateUpdate[]>;
/**
 ...
 */
export declare function listFundingRateCandles(pool: string, intervalSeconds: number, opts: {
    limit?: number;
    offset?: number;
    from?: number | bigint;
    to?: number | bigint;
} | undefined, indexerUrl: string): Promise<FundingRateCandle[]>;
/**
 ...
 */
export declare function getFundingRateHistory(pool: string, opts: {
    limit?: number;
    offset?: number;
    from?: number | bigint;
    to?: number | bigint;
 ...
 */
export declare function listPerpFees(opts: {
    account?: string;
    pool?: string;
    builder?: string;
    kind?: string;
    limit?: number;
    offset?: number;
} | undefined, indexerUrl: string): Promise<PerpFeeRecord[]>;
/** A perp pool's open-interest history, newest first — paginated. */
export declare function getOpenInterestHistory(pool: string, opts: {
    limit?: number;
    offset?: number;
} | undefined, indexerUrl: string): Promise<OpenInterestSnapshot[]>;
