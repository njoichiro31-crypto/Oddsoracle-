 ...
 *  ```
 */
export declare function setManualVaultMode(w: WriterCtx, p: SetManualVaultModeParams): Promise<TxResult>;
 ...
 */
export declare function getManualVaultMode(p: GetManualVaultModeParams, client: PublicClient): Promise<boolean>;
