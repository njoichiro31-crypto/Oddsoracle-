 ...
 *  ```
 */
export declare function getAutoPullRequirement(p: GetAutoPullRequirementParams, client: PublicClient): Promise<AutoPullRequirement>;
 ...
 */
export declare function isOperatorAuthorized(p: IsOperatorAuthorizedParams, client: PublicClient): Promise<boolean>;
 ...
 */
export declare function getOwnLockedBalance(p: {
    pool: Address;
    owner: Address;
}, client: PublicClient): Promise<LockedBalance>;
 ...
 *  breakdown uses.
 */
export declare function getLockedTokenBreakdown(pool: Address, client: PublicClient): Promise<LockedTokenBreakdown>;
/**
 ...
 */
export declare function convertToQuoteAtPriceCeil(p: {
    pool: Address;
    baseQuantity: bigint;
    price: bigint;
