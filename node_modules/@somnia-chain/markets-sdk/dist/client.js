...
import { ChainDoesNotSupportContract, createPublicClient, webSocket, } from "viem";
 ...
 *  by the same `catch`.
 */
export function makePublicClient(chain, wsRpcUrl) {
 ...
 */
export function withTypedReadErrors(client) {
    ...
    if (typeof client.call === "function") {
        ...
        decorated.call = async (args) => {
            try {
                ...
                throw Revert.toSdkError(e, "eth_call", { address: args.to });
            }
        };
    }
        ...
        decorated.multicall = async (args) => {
            try {
                ...
                throw Revert.toSdkError(e, "multicall", {
                    address: args.contracts?.[0]?.address,
                });
            }
        };
    }
