...
export const FUNDING_PRECISION = 1000000000000000000n;
 ...
 *  ```
 */
export function normalizeFundingRate(rate, fundingWindowSec, targetSec) {
 ...
 */
export function fundingRate8h(rate, fundingWindowSec) {
    return normalizeFundingRate(rate, fundingWindowSec, EIGHT_HOURS_SEC);
}
/** The rate per hour. */
export function fundingRate1h(rate, fundingWindowSec) {
 ...
 */
export function fundingRatePerInterval(rate, fundingWindowSec, fundingIntervalSec) {
 ...
 */
export function annualizedFundingRate(rate, fundingWindowSec) {
    assertWindow(fundingWindowSec);
 ...
 */
export function intervalsPerWindow(fundingWindowSec, fundingIntervalSec) {
    assertWindow(fundingWindowSec);
 ...
 */
export function realizedFundingPerBase(cumulativeStart, cumulativeEnd) {
 ...
 */
export function isFundingStale(lastFundingUpdateAt, fundingIntervalSec, nowSec, staleAfterIntervals = 2) {
 ...
 */
export function densifyFundingBuckets(candles, intervalSeconds, from, to) {
 ...
 */
export function buildFundingRateSeries(rows, intervalSeconds, from, to, limit) {
...
function assertWindow(fundingWindowSec) {
    if (!Number.isFinite(fundingWindowSec) || fundingWindowSec <= 0) {
        throw new RangeError(`fundingWindowSec must be positive, got ${fundingWindowSec} — ` +
