 ...
 */
export function expiryCode(expirySec) {
 ...
 */
export function synthesizeSymbol(m, codeOf) {
 ...
 */
export function withCollisionSuffix(symbol, m) {
...
export function tradableSymbol(marketSymbol, outcome) {
...
export function isChainRef(ref) {
