 ...
 */
export function isRevert(value) {
    if (findRevertData(value) !== undefined)
        return true;
    const seen = new Set();
    let node = value;
    for (let depth = 0; node != null && depth < 10; depth += 1) {
 ...
 */
export function decodeRevert(caught, context = {}) {
    ...
    if (caught instanceof ContractRevertError) {
        if (context.address === undefined && context.functionName === undefined)
            return caught;
