 ...
 */
export function accrueLinear(indexRay, rateRay, lastUpdateTimestamp, nowSec) {
 ...
 */
export function accrueCompounded(indexRay, rateRay, lastUpdateTimestamp, nowSec) {
    const dt = BigInt(Math.max(0, nowSec - lastUpdateTimestamp));
    if (dt === 0n)
        return indexRay;
 ...
 * ```
 */
export function lendRayRateToApy(rateRay) {
