...
export function portfolioKey(account, opts) {
    return [
        QUERY_KEY_SCOPE,
        "portfolio",
        id(account),
...
export function candlesKey(pool, intervalSeconds, opts) {
    return [
        QUERY_KEY_SCOPE,
        "candles",
        id(pool),
...
export function marketCreatorsKey(opts) {
    return [
        QUERY_KEY_SCOPE,
        "marketCreators",
        pruned({
