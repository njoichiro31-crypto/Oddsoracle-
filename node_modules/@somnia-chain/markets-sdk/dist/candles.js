 ...
 *  (ready for charting).
 */
export async function getCandles(poolAddress, intervalSeconds, opts = {}, indexerUrl) {
    const where = {
    ...
    const data = await IndexerRead.gqlRequest(CandlesQuery, { where, limit: opts.limit ?? 500 }, indexerUrl);
 ...
 */
export const CANDLE_INTERVALS = [60, 300, 900, 3600, 14400, 86400];
// prettier-ignore
