 ...
 */
export function outcomeId(pool, nonce, idx) {
...
export function decodeOutcomeId(id) {
    ...
    const pool = `0x${(id >> POOL_SHIFT).toString(16).padStart(40, "0")}`;
 ...
 */
export function marketKey(outcomeId) {
