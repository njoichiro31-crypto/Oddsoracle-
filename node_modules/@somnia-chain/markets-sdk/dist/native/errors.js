...
const STATUS_VALUES = new Set(Object.values(SomniaMempoolStatus));
/**
 ...
 */
export function getSomniaRpcError(error) {
    let node = error;
    let found = null;
    let details = null;
    ...
    const data = typeof found.data === "string" && found.data.startsWith("0x") ? found.data : null;
...
function decodeStatus(data) {
    ...
    if (body.length !== 2)
        return null; // exactly one byte, or it isn't a status code
